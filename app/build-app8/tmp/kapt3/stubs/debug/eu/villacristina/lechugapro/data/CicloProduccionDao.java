...
public abstract interface CicloProduccionDao {
    ...
    @androidx.room.Query(value = "SELECT * FROM ciclos_produccion WHERE estado != \'Archivado\' OR estado IS NULL ORDER BY id DESC LIMIT 1")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object getUltimoActivo(@org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super eu.villacristina.lechugapro.data.CicloProduccion> $completion);
}