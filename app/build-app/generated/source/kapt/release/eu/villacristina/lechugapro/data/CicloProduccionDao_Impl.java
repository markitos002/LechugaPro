...
public final class CicloProduccionDao_Impl implements CicloProduccionDao {
  ...
  public CicloProduccionDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCicloProduccion = new EntityInsertionAdapter<CicloProduccion>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `ciclos_produccion` (`id`,`numeroCiclo`,`variedad`,`numeroPlantas`,`fechaInicioPreparacionTierra`,`fechaFinPreparacionTierra`,`fechaAbono`,`fechaSiembra`,`fechaSuplementoMinerales`,`fechaEstimadaCosecha`,`fechaRealCosecha`,`notas`,`estado`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getEstado() == null) {
          ...
          statement.bindString(13, entity.getEstado());
        }
      }
    };
    this.__updateAdapterOfCicloProduccion = new EntityDeletionOrUpdateAdapter<CicloProduccion>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `ciclos_produccion` SET `id` = ?,`numeroCiclo` = ?,`variedad` = ?,`numeroPlantas` = ?,`fechaInicioPreparacionTierra` = ?,`fechaFinPreparacionTierra` = ?,`fechaAbono` = ?,`fechaSiembra` = ?,`fechaSuplementoMinerales` = ?,`fechaEstimadaCosecha` = ?,`fechaRealCosecha` = ?,`notas` = ?,`estado` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public LiveData<List<CicloProduccion>> getAll() {
    final String _sql = "SELECT * FROM ciclos_produccion";
      ...
      public List<CicloProduccion> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new CicloProduccion(_tmpId,_tmpNumeroCiclo,_tmpVariedad,_tmpNumeroPlantas,_tmpFechaInicioPreparacionTierra,_tmpFechaFinPreparacionTierra,_tmpFechaAbono,_tmpFechaSiembra,_tmpFechaSuplementoMinerales,_tmpFechaEstimadaCosecha,_tmpFechaRealCosecha,_tmpNotas,_tmpEstado);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public CicloProduccion call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new CicloProduccion(_tmpId,_tmpNumeroCiclo,_tmpVariedad,_tmpNumeroPlantas,_tmpFechaInicioPreparacionTierra,_tmpFechaFinPreparacionTierra,_tmpFechaAbono,_tmpFechaSiembra,_tmpFechaSuplementoMinerales,_tmpFechaEstimadaCosecha,_tmpFechaRealCosecha,_tmpNotas,_tmpEstado);
          } else {
            _result = null;
          }
          return _result;
