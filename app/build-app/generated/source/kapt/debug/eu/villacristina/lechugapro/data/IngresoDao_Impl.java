  ...
  public IngresoDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfIngreso = new EntityInsertionAdapter<Ingreso>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `ingresos` (`id`,`id_cliente`,`fecha`,`concepto`,`importe`,`notas`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfIngreso = new EntityDeletionOrUpdateAdapter<Ingreso>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `ingresos` SET `id` = ?,`id_cliente` = ?,`fecha` = ?,`concepto` = ?,`importe` = ?,`notas` = ? WHERE `id` = ?";
      }
      ...
      public Ingreso call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new Ingreso(_tmpId,_tmpIdCliente,_tmpFecha,_tmpConcepto,_tmpImporte,_tmpNotas);
          } else {
            _result = null;
          }
          return _result;
      ...
      public List<Ingreso> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Ingreso(_tmpId,_tmpIdCliente,_tmpFecha,_tmpConcepto,_tmpImporte,_tmpNotas);
            _result.add(_item);
          }
          return _result;
        } finally {
