...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(11) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `ingresos` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `id_cliente` INTEGER NOT NULL, `fecha` INTEGER NOT NULL, `concepto` TEXT NOT NULL, `importe` REAL NOT NULL, `estado_pago` TEXT NOT NULL, `notas` TEXT, FOREIGN KEY(`id_cliente`) REFERENCES `clientes`(`id`) ON UPDATE NO ACTION ON DELETE CASCADE )");
        db.execSQL("CREATE INDEX IF NOT EXISTS `index_ingresos_id_cliente` ON `ingresos` (`id_cliente`)");
        db.execSQL("CREATE TABLE IF NOT EXISTS `gastos` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `id_ciclo` INTEGER NOT NULL, `tipo` TEXT NOT NULL, `importe` REAL NOT NULL, `fecha` INTEGER NOT NULL)");
        db.execSQL("CREATE INDEX IF NOT EXISTS `index_gastos_id_ciclo` ON `gastos` (`id_ciclo`)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '6e85ab225f574756e0184650d1900c1c')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsIngresos = new HashMap<String, TableInfo.Column>(7);
        ...
        _columnsIngresos.put("estado_pago", new TableInfo.Column("estado_pago", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsGastos.put("id_ciclo", new TableInfo.Column("id_ciclo", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsGastos.put("tipo", new TableInfo.Column("tipo", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _indicesGastos.add(new TableInfo.Index("index_gastos_id_ciclo", false, Arrays.asList("id_ciclo"), Arrays.asList("ASC")));
        ...
        if (!_infoGastos.equals(_existingGastos)) {
          return new RoomOpenHelper.ValidationResult(false, "gastos(eu.villacristina.lechugapro.data.Gasto).\n"
                  + " Expected:\n" + _infoGastos + "\n"
                  + " Found:\n" + _existingGastos);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "6e85ab225f574756e0184650d1900c1c", "3ecaa2c56dc5602e2fb72bb5984b7805");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "ciclos_produccion","clientes","ingresos","gastos");
  }
